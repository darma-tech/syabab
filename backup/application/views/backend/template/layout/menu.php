        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="<?= base_url('produk/kategori') ?>"> Kategori Produk </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="forms" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="<?= base_url('Laporan/pembelian') ?>"> Pembelian </a>
                    </li>
            ...
            <li class="menu">
                <a href="<?= base_url('costumer') ?>" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
