<script src="<?= base_url() ?>assets/backend/js/libs/jquery-3.1.1.min.js"></script>
<script src="<?= base_url() ?>assets/backend/bootstrap/js/popper.min.js"></script>
...
<script src="<?= base_url() ?>assets/backend/plugins/apex/apexcharts.min.js"></script>
<script src="<?= base_url() ?>assets/backend/js/dashboard/dash_1.js"></script>
<script src="<?= base_url() ?>assets/backend/js/scrollspyNav.js"></script>

<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?= base_url() ?>assets/backend/plugins/table/datatable/datatables.js"></script>
<script>
