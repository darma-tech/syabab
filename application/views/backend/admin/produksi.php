                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="<?= site_url('admin/tambah_pembelian') ?>" method="post" id="form-stok-pembelian">
                                                <div class="form-group row">
                                                    <label class="required col-form-label col-md-4 text-black" for="nama">Nama Produk</label>
                                                    <div class="col-md-8">
                                                        <select class="form-control basic" name="bahabaku" id="bahabaku">
                                                            <option selected="selected" value="">--Pilih Bahan Baku--
                                                            </option>
                                                ...
                                                <div class="form-group row">
                                                    <label class="required col-form-label col-md-4 text-black" for="jlhproduksi">Jumlah</label>
                                                    <div class="col-md-8">
                                                        <input type="text" name="jlhproduksi" class="form-control" id="jlhproduksi" required>
                                                    </div>
                                                </div>
