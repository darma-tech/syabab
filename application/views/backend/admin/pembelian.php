				...
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
						<div class="widget-content widget-content-area br-6">
							<div class="ml-3">
								<button class="btn btn-primary" aria-expanded="false" aria-controls="collapseForm" data-toggle="collapse" data-target="#form-tambah">Tambah Pembelian
								</button>
							</div>
											...
											<form id="form-submit-array">
												...
												<div class="col-md-5">
													<div class="form-group">
														<input type="text" name="no_faktur" class="form-control" placeholder="Nomor Faktur" id="no_faktur" value="<?= set_value('no_faktur') ?>" autofocus>
													</div>
													<div class="form-group">
														<select class="form-control basic" name="supplier" id="supplier">
												...
												<div class="col-md-12 mt-2">
													...
													<div class="table-responsive">
														<table id="table-add-pembelian" class="table" width="100%">
															<thead>
																<tr>
																	...
																	<th width="">Total</th>
																	<th width="">
																		<button type="button" title="tambah" class="gayaku bs-tooltip" id="btn-add-row">
																			<i class="p-1 mb-1 br-6 icon-tambah" data-feather="plus-circle"></i>
																		</button>
																	</th>
																</tr>
															</thead>
												...
												<div class="col-md-8 mt-3">
													...
													<div class="form-group row">
														<label for="" class="col-form-label col-md-3 text-black">Total
															Bayar</label>
														<div class="col-md-5">
															<input type="number" min="0" class="form-control" name="total_bayar" id="total_bayar">
														</div>
													</div>
												</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td>Rp. <?= $p['total'] ?></td>
												<td>
													<button id="btn-edit" title="Edit data" class="gayaku bs-tooltip" data-id="<?= $p['id'] ?>">
														<i class="p-1 br-6 mb-1" data-feather="edit"></i>
													</button>
													<button id="btn-hapus" title="Hapus" class="gayaku bs-tooltip" data-id="<?= $p['id'] ?>">
