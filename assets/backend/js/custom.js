	...
	$('#btn-add-row').click(function () {
		...
		$.ajax({
			...
			success: function (data) {
				...
				html += '</select></td>' +
					'<td><input class="form-control lebar jlh"  type="number" min="0" name="jumlah[]"></td>' +
					'<td><input class="form-control lebar bayar" type="number" min="0" name="harga[]">' +
					'<input class="form-control" hidden id="faktur_row" type="text" name="faktur[]"></td>' +
					'<td><input class="form-control lebar" type="text" name="total" id="total" readonly></td>' +
